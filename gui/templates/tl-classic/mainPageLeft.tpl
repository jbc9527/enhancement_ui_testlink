...
{$aStyle="padding: 3px 15px;font-size:16px;background-color:#e0f0ff"}
{$hStyle="padding: 3px 15px;font-size:16px;background-color:#5c5c6b;color:#fff"}
  ...
  {if $display_left_block_top}
    {if isset($gui->plugins.EVENT_LEFTMENU_TOP)}
      <div class="list-group" style="{$divStyle}" id="plugin_left_top">
        <h6 class="list-group-item" style="{$hStyle}">Top</h6>
...
{if $display_left_block_2}
  <div class="list-group" style="{$divStyle}">
    <h6 class="list-group-item" style="{$hStyle}">Tracker Management</h6>
...
{if $display_left_block_1}
  <div class="list-group" style="{$divStyle}">
    <h6 class="list-group-item" style="{$hStyle}">Test Project</h6>
...
{if $display_left_block_3}
  <div class="list-group" style="{$divStyle}">
       <h6 class="list-group-item" style="{$hStyle}">Requirements</h6>
...
{if $display_left_block_4}
    <div class="list-group" style="{$divStyle}">
      <h6 class="list-group-item" style="{$hStyle}">Test Specification</h6>
  ...
  {if $display_left_block_bottom}
    {if isset($gui->plugins.EVENT_LEFTMENU_BOTTOM)}
	  ...
	  <div class="list-group" style="{$divStyle}" id="plugin_left_bottom">
        <h6 class="list-group-item" style="{$hStyle}">Events</h6>
