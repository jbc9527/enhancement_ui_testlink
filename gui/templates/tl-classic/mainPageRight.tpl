...
<div class="vertical_menu" style="float: right; margin:0px 0px 10px 10px;width: 320px;">
  ...
  {if $display_right_block_1}
    <div class="list-group" style="{$divStyle}">
      <h6 class="list-group-item" style="{$hStyle}">Test Plan</h6>
  ...
  {if $display_right_block_2}
    <div class="list-group" style="{$divStyle}">
        <h6 class="list-group-item" style="{$hStyle}">Test Execution</h6>
  ...
  {if $display_right_block_bottom}
    ...
    <div class="list-group" style="{$divStyle}" id="plugin_right_bottom">
      <h6 class="list-group-item" style="{$hStyle}">Powered By</h6>
    <br/>
    <address>
